...
@endforeach
													<div class="error-top up">
														...
														<h3 class="inner-tittle t-inner">Sign Up</h3>
                                                                <form action="{{url('profile/insertUSER')}}" method="POST" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="form-group">
    <label for="formGroupExampleInput">Example label</label>
   
    <input type="text" class="form-control" name="email" placeholder="inter email">
    <input type="name" class="form-control"  name="name" placeholder="inter name">
   ...
   image <input  type="file"   name="image"><br>
																		...
																		<div class="new">
																			<p class="sign up">Do you have an account yet ? <a href="{{route('profile.login')}}"> Login here.</a></p>
																			<div class="clearfix"></div>
																		</div>
																	</form>
														</div>
